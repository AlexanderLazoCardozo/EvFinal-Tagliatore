          ...
          >
            ...
            <ul className="menu-inner py-1">
              <li className="menu-header small text-uppercase">
                <span className="menu-header-text">Mantenimientos</span>
              </li>

              <li className="menu-item">
                <a href="/clientes" className="menu-link">
                  <i className="menu-icon tf-icons bx bx-user"></i>
                  <div data-i18n="Basic">Clientes</div>
                </a>
              </li>
              <li className="menu-item">
                <a href="/platillos" className="menu-link">
                  <i className="menu-icon tf-icons bx bx-food-menu"></i>
                  <div data-i18n="Basic">Platillos</div>
                </a>
              </li>
              <li className="menu-item">
                <a href="/ordenes" className="menu-link">
              ...
              <li className="menu-item">
                <a href="/meseros" className="menu-link">
                  <i className="menu-icon tf-icons bx bx-user-circle"></i>
                  <div data-i18n="Basic">Meseros</div>
                </a>
              </li>
            </ul>
          </aside>
